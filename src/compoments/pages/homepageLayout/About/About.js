    ...
    <div className='container place-center'>
       ...
       <div className='items_blogs'>
        ...
        <div className='join_btn_component'>
           ...
           <div className='flex-btn space-x-36'>
            <button className='btn'>Business Name</button>
            <button className='btn'>Email</button>
           </div>

           <div className='colume-btn'>
            {/* <button className='border border-indigo-600 bg-indigo-500 rounded   w-full p-4 my-2 text-white transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-indigo-600 duration-300 '>Notify me</button> */}
            {/* <button>Sgn up as a freelance partner</button> */}
           </div>
        </div>
