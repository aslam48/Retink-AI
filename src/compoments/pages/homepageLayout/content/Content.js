    ...
    <section>
      <div className="container text_and_img_context">
        <div>
          ...
          <p className="text">
            + Expert Created <span className="logo-text">Logo</span>
          </p>

          <div className="content-box">
            <p className="context-text">
              Boost your sales <span className="indigo">10x faster</span> with
              content customization by our unique partnership of{" "}
